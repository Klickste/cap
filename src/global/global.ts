...
export default async () => {
	...
	const levelsBase: number = parseInt(style.getPropertyValue('--cap-text-levels-base'))
	const levelsRatio: number = parseFloat(style.getPropertyValue('--cap-text-levels-ratio'))
	const levelsDown: number = parseInt(style.getPropertyValue('--cap-text-levels-down'))
	const levelsUp: number = parseInt(style.getPropertyValue('--cap-text-levels-up'))
